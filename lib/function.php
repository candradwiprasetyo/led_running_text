...
function get_header_chart($title = ""){
	include '../views/layout/header_chart.php';
}
...
function get_footer_chart($query_find = 0){
	include '../views/layout/footer_chart.php';
}
...
function get_rupiah($nilai, $pecahan = 0) { 

    ...
    */
    ...
    {
        context.font = (arguments[11] ? 'Bold ': '') + size + 'px ' + font;
        var i;
        var origX = x;
        var origY = y;
    ...
    */
    RGraph.DrawTitle = function (canvas, text, gutter)
    {
        ...
        var size    = arguments[4] ? arguments[4] : 14;
        ...
        */
        RGraph.Text(context, 'Verdana', size, centerx, vpos, text, vCenter, 'center', null, null, null, true);
        ...
        */
        ...
        if (keypos && keypos == 'gutter') {
            ...
            for (i=0; i<key.length; ++i) {
                ...
                RGraph.Text(context, 'Verdana', textsize,
                                             start + 25,
                                             gutter - 6 - textsize,
                                             key[i],
                                             'top');
        ...
        */
            ...
            */
            ...
            for (var i=key.length - 1; i>=0; i--) {
                ...
                RGraph.Text(context, 'Verdana', textsize, xpos + 21, gutter + (5 * j) + (textsize * j) + 4, key[i]);
            }
